...
|---|---|---|
| **`repro/out/intendant_red_4x5.mp4`** | **1080 × 1350 @ 60 fps** | **fil Facebook / Instagram — le format de diffusion** |
| `repro/out/intendant_red_16x9.mp4` | 1920 × 1080 @ 60 fps | in-stream, présentation, master |
...
39,0 s. Plus de 9:16 : le fil est le seul placement visé.

## Typographie — la charte du client

**Didot** porte les cinq moments de parole : la question de l'horloge, « c'est un
vrai métier », « vous ne gérez plus rien », « Ce qu'en disent les propriétaires »,
« Nous gérons, vous percevez ». Plus le nom de la marque, parce que le losange
contient un « I » à empattements : en Futura, le lockup mettait deux alphabets
côte à côte.

**Futura** porte tout le fonctionnel : cartes d'avis, lignes de l'agenda,
réservations, plateformes, libellés du parcours, mentions de la carte finale.

**Il n'y a plus de troisième police.** JetBrains Mono servait aux dates et aux
montants ; la charte n'en prévoit que deux, donc ils passent en Futura.

### Deux contraintes à connaître

**Les graisses.** Le Futura de macOS ne fournit que Medium et Bold. Les vingt
occurrences du projet en 400 et 600 auraient été *synthétisées* par le
navigateur, ce qui déforme la géométrie du dessin. Elles sont remappées sur 500
et 700, et deux constantes (`W_MED`, `W_BOLD`) existent pour que la règle soit
appliquée plutôt que retenue.

**La portabilité.** Didot et Futura sont sous licence et absentes de Google
Fonts, mais installées sur macOS : Chrome les résout par nom de famille, donc le
film obtient la vraie charte et non des approximations. En contrepartie, un rendu
sur une machine qui ne les a pas basculerait sur les replis (Bodoni, Jost) et les
métriques bougeraient. Risque assumé et documenté dans `theme.ts`, pas masqué.
...
| Parcours | colonne d'arrivée à 82 %, libellés **sous** la tuile, chiffre fantôme au-dessus. **3 étapes** : Annonce et photos, Accueil 7 j/7, Ménage hôtelier. *Tarification dynamique* et *Reporting mensuel* ont sauté — le film fait déjà deux fois l'argument financier, avec les versements de l'agenda et la chute « Nous gérons, vous percevez ». Les symboles prennent l'encre sombre du thème : à pleine saturation ils se battaient avec la tuile blanche |
