...
const MORPH_R = (f: number) => {
  if (f <= 2126) return 1400 * inCubic(prog(f, 2094, 2126));   // the pill floods out
  return 1400 + (32 - 1400) * softOut(prog(f, 2130, 2188));    // and contracts to the badge
};
